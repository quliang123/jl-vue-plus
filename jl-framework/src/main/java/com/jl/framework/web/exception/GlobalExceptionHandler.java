package com.jl.framework.web.exception;
...
import com.jl.common.exception.DemoModeException;
import com.jl.common.exception.file.FileSizeLimitExceededException;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult checkMaxFileSize(FileSizeLimitExceededException e){
        log.error(e.getMessage(), e);
        return AjaxResult.error(HttpStatus.HTTP_NOT_FOUND, "文件大小不能超过20M");
    }
}
